...
void init_conv2d_layer(conv2d_layer_t *layer, uint8_t filters, uint8_t kernel_size, uint8_t pad_size, activation_func  act_func, float * weights, uint8_t input_rows, uint8_t input_cols, uint8_t input_channel);
